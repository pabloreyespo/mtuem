...
```{r example-3eq-profiled, eval = FALSE}
library(mtuem)
library(apollo)
...
```{r example-3eq-cholesky, eval = FALSE}
library(mtuem)
library(apollo)
...
```{r example-lc-2class-cholesky, eval = FALSE}
library(mtuem)
library(apollo)
...
```{r example-lc-2class-profiled, eval = FALSE}
library(mtuem)
library(apollo)
...
```{r example-lc-2class-shared, eval = FALSE}
library(mtuem)
library(apollo)
