...
$$
\begin{align}
Max\ U(X,T) &= \left(\theta_w T_w - \frac{1}{2}\beta_w T_w^2 \right) + \sum_{i\in A} \left( \theta_i T_i - \frac{1}{2}\beta_i T_i^2  \right) + \sum_{j\in G} \left( \phi_j X_j - \frac{1}{2}\eta_j X_j^2  \right) \\
&+\sum_{i\in A}\sum_{j\in G} \left(\gamma_{ij}T_iX_j\right) + \sum_{j\in G} \left(\gamma_{wj}T_wX_j\right)\tag{1}
\end{align}
$$
subject to:
$$
...
$$
\begin{align}
L(X,T;\lambda,\mu,\kappa_i,\psi_j)&=\left(\theta_w T_w - \frac{1}{2}\beta_w T_w^2 \right) + \sum_{i\in A} \left( \theta_i T_i - \frac{1}{2}\beta_i T_i^2  \right) + \sum_{j\in G} \left( \phi_j X_j - \frac{1}{2}\eta_j X_j^2  \right) +\sum_{i\in A}\sum_{j\in G} \left(\gamma_{ij}T_iX_j\right) + \sum_{j\in G} \left(\gamma_{wj}T_wX_j\right) \\
